\section{Projeto}
	Esse projeto é um gerenciador de campeonatos, é proposto a arquitetura e funcionamento de um sistema moderno de classificações, colocações e decisões de partidas, todas automáticas e com relatorios. Além disso a implementação de um ranking por jogador.
